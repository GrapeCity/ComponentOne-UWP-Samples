...
namespace TileViewSamples.Data
{
    /// <summary>
    /// Base class for <see cref="SampleDataItem"/> that defines common properties.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : TileViewSamples.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            _allItems.Add(new SampleDataItem("DashBoard",
                    Strings.DashBoardTitle,
                    Strings.DashBoardDescription,
                    "Assets/LightGray.png",
                     typeof(TileViewSamples.MainPage1),
                     Strings.DashBoardName));
            _allItems.Add(new SampleDataItem("CustomLook",
                    Strings.CustomLookTitle,
                    Strings.CustomLookDescription,
                    "Assets/LightGray.png",
                    typeof(TileViewSamples.MainPage2),
                    Strings.CustomLookName));
            _allItems.Add(new SampleDataItem("AmazonBooks",
                    Strings.AmazonBooksTitle,
                    Strings.AmazonBooksDescription,
                    "Assets/LightGray.png",
                    typeof(TileViewSamples.AmazonBooksPage),
                    Strings.AmazonBooksName));
            _allItems.Add(new SampleDataItem("Virtualization",
                    Strings.VirtualizationTitle,
                    Strings.VirtualizationDescription,
                    "Assets/LightGray.png",
                    typeof(TileViewSamples.BlankPage),
                    Strings.VirtualizationName));
        }
    }
}
