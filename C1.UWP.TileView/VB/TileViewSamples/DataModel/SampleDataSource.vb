...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("DashBoard", Strings.DashBoardTitle, Strings.DashBoardDescription, "Assets/LightGray.png", GetType(MainPage1), Strings.DashBoardName))
            _allItems.Add(New SampleDataItem("CustomLook", Strings.CustomLookTitle, Strings.CustomLookDescription, "Assets/LightGray.png", GetType(MainPage2), Strings.CustomLookName))
            _allItems.Add(New SampleDataItem("AmazonBooks", Strings.AmazonBooksTitle, Strings.AmazonBooksDescription, "Assets/LightGray.png", GetType(AmazonBooksPage), Strings.AmazonBooksName))
            _allItems.Add(New SampleDataItem("Virtualization", Strings.VirtualizationTitle, Strings.VirtualizationDescription, "Assets/LightGray.png", GetType(BlankPage), Strings.VirtualizationName))
        End Sub
    End Class
End Namespace