...
namespace CalendarSamples.Data
{
    /// <summary>
    /// Base class for <see cref="SampleDataItem"/> that defines common properties.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : CalendarSamples.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        public SampleDataSource()
        {
            _allItems.Add(new SampleDataItem("Default",
                   Strings.CalendarSamplesDefaultTitle,
                   Strings.CalendarSamplesDefaultDescription,
                   "",
                   typeof(CalendarSamples.DefaultView),
                   Strings.CalendarSamplesDefaultName));
            _allItems.Add(new SampleDataItem("Bolded Days",
                  Strings.CalendarSamplesBoldedDaysTitle,
                  Strings.CalendarSamplesBoldedDaysDescription,
                  "",
                  typeof(CalendarSamples.BoldedDayTemplate),
                  Strings.CalendarSamplesBoldedDaysName));
            _allItems.Add(new SampleDataItem("Custom Days",
                 Strings.CalendarSamplesCustomDaysTitle,
                 Strings.CalendarSamplesCustomDaysDescription,
                 "",
                 typeof(CalendarSamples.DaySlotTemplateSelector),
                 Strings.CalendarSamplesCustomDaysName));
            _allItems.Add(new SampleDataItem("Custom Data",
                 Strings.CalendarSamplesCustomDataTitle,
                 Strings.CalendarSamplesCustomDataDescription,
                 "",
                 typeof(CalendarSamples.CustomData),
                 Strings.CalendarSamplesCustomDataName));
        }
    }
}
