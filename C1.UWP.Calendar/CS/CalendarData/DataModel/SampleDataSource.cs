...
namespace CalendarData.Data
{
    /// <summary>
    /// Base class for <see cref="SampleDataItem"/> that defines common properties.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : CalendarData.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            _allItems.Add(new SampleDataItem("CustomData",
                   Strings.CalendarDataTitle,
                   Strings.CalendarDatatDescription,
                   "",
                   typeof(CalendarData.CalendarDataDemo),
                   Strings.CalendarDataName));
        }
    }
}
