    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("Default",
                   ...
                   "",
                   GetType(CalendarSamples.DefaultView),
            ...
            _allItems.Add(New SampleDataItem("Bolded Days",
                  ...
                  "",
                  GetType(CalendarSamples.BoldedDayTemplate),
            ...
            _allItems.Add(New SampleDataItem("Custom Days",
                 ...
                 "",
                 GetType(CalendarSamples.DaySlotTemplateSelector),
            ...
            _allItems.Add(New SampleDataItem("Custom Data",
                 ...
                 "",
                 GetType(CalendarSamples.CustomData),
