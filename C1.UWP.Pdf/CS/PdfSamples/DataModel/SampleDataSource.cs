...
namespace PdfSamples.Data
{
    /// <summary>
    /// Base class for <see cref="SampleDataItem"/> that defines common properties.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : PdfSamples.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        public SampleDataSource()
        {
            _allItems.Add(new SampleDataItem("Basic Text",
                 Strings.PdfSamplesBasicTextTitle,
                 Strings.PdfSamplesBasicTextDescription,
                 "Assets/BasicText.png",
                 typeof(PdfSamples.BasicTextPage),
                 Strings.PdfSamplesBasicTextName));
            _allItems.Add(new SampleDataItem("Images",
                  Strings.PdfSamplesImagesTitle,
                  Strings.PdfSamplesImagesDescription,
                  "Assets/MediumGray.png",
                  typeof(PdfSamples.ImagesPage),
                  Strings.PdfSamplesImagesName));
            _allItems.Add(new SampleDataItem("Graphics",
                   Strings.PdfSamplesGraphicsTitle,
                   Strings.PdfSamplesGraphicsDescription,
                   "Assets/Graphics.png",
                   typeof(PdfSamples.GraphicsPage),
                   Strings.PdfSamplesGraphicsName));
            _allItems.Add(new SampleDataItem("Quotes",
                   Strings.PdfSamplesQuotesTitle,
                   Strings.PdfSamplesQuotesDescription,
                   "Assets/Quotes.png",
                   typeof(PdfSamples.QuotesPage),
                   Strings.PdfSamplesQuotesName));
            _allItems.Add(new SampleDataItem("Table of Contents",
                   Strings.PdfSamplesTableOfContentsTitle,
                   Strings.PdfSamplesTableOfContentsDescription,
                   "Assets/TOC.png",
                   typeof(PdfSamples.TOCPage),
                   Strings.PdfSamplesTableOfContentsName));
            _allItems.Add(new SampleDataItem("Text Flow",
                   Strings.PdfSamplesTextFlowTitle,
                   Strings.PdfSamplesTextFlowDescription,
                   "Assets/TextFlow.png",
                   typeof(PdfSamples.TextFlowPage),
                   Strings.PdfSamplesTextFlowName));
            _allItems.Add(new SampleDataItem("Paper Sizes",
                   Strings.PdfSamplesPaperSizesTitle,
                   Strings.PdfSamplesPaperSizesDescription,
                   "Assets/PaperSizes.png",
                   typeof(PdfSamples.PaperSizesPage),
                   Strings.PdfSamplesPaperSizesName));
            _allItems.Add(new SampleDataItem("Export UI",
                  Strings.PdfSamplesExportUITitle,
                  Strings.PdfSamplesExportUIDescription,
                  "Assets/MediumGray.png",
                  typeof(PdfSamples.RenderUIPage),
                  Strings.PdfSamplesExportUIName));
