...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("Basic Text", Strings.PdfSamplesBasicTextTitle, Strings.PdfSamplesBasicTextDescription, "Assets/BasicText.png", GetType(BasicTextPage), Strings.PdfSamplesBasicTextName))
            _allItems.Add(New SampleDataItem("Images", Strings.PdfSamplesImagesTitle, Strings.PdfSamplesImagesDescription, "Assets/MediumGray.png", GetType(ImagesPage), Strings.PdfSamplesImagesName))
            _allItems.Add(New SampleDataItem("Graphics", Strings.PdfSamplesGraphicsTitle, Strings.PdfSamplesGraphicsDescription, "Assets/Graphics.png", GetType(GraphicsPage), Strings.PdfSamplesGraphicsName))
            _allItems.Add(New SampleDataItem("Quotes", Strings.PdfSamplesQuotesTitle, Strings.PdfSamplesQuotesDescription, "Assets/Quotes.png", GetType(QuotesPage), Strings.PdfSamplesQuotesName))
            _allItems.Add(New SampleDataItem("Table of Contents", Strings.PdfSamplesTableOfContentsTitle, Strings.PdfSamplesTableOfContentsDescription, "Assets/TOC.png", GetType(TOCPage), Strings.PdfSamplesTableOfContentsName))
            _allItems.Add(New SampleDataItem("Text Flow", Strings.PdfSamplesTextFlowTitle, Strings.PdfSamplesTextFlowDescription, "Assets/TextFlow.png", GetType(TextFlowPage), Strings.PdfSamplesTextFlowName))
            _allItems.Add(New SampleDataItem("Paper Sizes", Strings.PdfSamplesPaperSizesTitle, Strings.PdfSamplesPaperSizesDescription, "Assets/PaperSizes.png", GetType(PaperSizesPage), Strings.PdfSamplesPaperSizesName))

            _allItems.Add(New SampleDataItem("Export UI", Strings.PdfSamplesExportUITitle, Strings.PdfSamplesExportUIDescription, "Assets/MediumGray.png", GetType(RenderUIPage), Strings.PdfSamplesExportUIName))
        End Sub
    End Class
End Namespace