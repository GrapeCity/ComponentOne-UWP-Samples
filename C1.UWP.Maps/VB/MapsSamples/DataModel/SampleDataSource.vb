...
Namespace Data
    ...
    Public MustInherit Class SampleDataCommon
        Inherits MapsSamples.Common.BindableBase
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("DemoMaps", Strings.DemoTitle, Strings.DemoDescription, "Assets/LightGray.png", GetType(DemoMaps), Strings.DemoName))
            _allItems.Add(New SampleDataItem("CustomTileSource", Strings.CustomTitle, Strings.CustomDescription, "Assets/LightGray.png", GetType(CustomTileSource), Strings.CustomName))
            _allItems.Add(New SampleDataItem("Cities", Strings.CitiesTitle, Strings.CitiesDescription, "Assets/LightGray.png", GetType(Cities), Strings.CitiesName))
            _allItems.Add(New SampleDataItem("EarthQuake", Strings.EarthQuakeTitle, Strings.EarthQuakeDescription, "Assets/LightGray.png", GetType(EarthQuake), Strings.EarthQuakeName))
            _allItems.Add(New SampleDataItem("Flicker", Strings.FlickrTitle, Strings.FlickrDescription, "Assets/LightGray.png", GetType(Flicker), Strings.FlickrName))
            _allItems.Add(New SampleDataItem("Grid", Strings.GridTitle, Strings.GridDescription, "Assets/LightGray.png", GetType(MapsSamples.Grid), Strings.GridName))
            _allItems.Add(New SampleDataItem("MapChart", Strings.ChartTitle, Strings.ChartDescription, "Assets/LightGray.png", GetType(MapChart), Strings.ChartName))
            _allItems.Add(New SampleDataItem("Marks", Strings.MarksTitle, Strings.MarksDescription, "Assets/LightGray.png", GetType(Marks), Strings.MarksName))
            _allItems.Add(New SampleDataItem("Factories", Strings.FactoriesTitle, Strings.FactoriesDescription, "Assert/LightGray.png", GetType(Factories), Strings.FactoriesName))
            _allItems.Add(New SampleDataItem("MapShape", Strings.ShapeTitle, Strings.ShapeDescription, "Assert/LightGray.png", GetType(MapShape), Strings.ShapeName))
        End Sub
    End Class
End Namespace