...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("Default", Strings.DefaultTitle, Strings.DefaultDescription, "", GetType(DefaultView), Strings.DefaultName))
            _allItems.Add(New SampleDataItem("Data binding", Strings.BindingTitle, Strings.BindingDescription, "", GetType(BusinessObjectsBinding), Strings.BindingName))
            _allItems.Add(New SampleDataItem("Save Local Data", Strings.SaveTitle, Strings.SaveDescription, "", GetType(SaveLocalData), Strings.SaveName))
        End Sub
    End Class
End Namespace