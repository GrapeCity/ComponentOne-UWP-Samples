...
namespace ZipSamples.Data
{
    /// <summary>
    /// Base class for <see cref="SampleDataItem"/> that defines common properties.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : ZipSamples.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        public SampleDataSource()
        {
            _allItems.Add(new SampleDataItem("See it in action",
                   Strings.DemoZipTitle,
                   Strings.DemoZipDescription,
                   "",
                   typeof(ZipSamples.DemoZip),
                   Strings.DemoZipName));
        }
    }
}
