...
using PdfDocumentSourceSamples;
...
namespace PdfDocumentSourceSamples.Data
{
    /// <summary>
    /// Base class for <see cref="SampleDataItem"/> that defines common properties.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : PdfDocumentSourceSamples.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        public SampleDataSource()
        {
            _allItems.Add(new SampleDataItem("Viewer",
                   Strings.PdfViewSamplePageTitle,
                   Strings.PdfViewSamplePageDescription,
                   "",
                   typeof(PdfDocumentSourceSamples.PdfViewPage),
                   Strings.PdfViewSamplePageName
                   ));
            ...
            _allItems.Add(new SampleDataItem("Export",
                   ...
                   "",
                   typeof(PdfDocumentSourceSamples.ExportPage),
            ...
            _allItems.Add(new SampleDataItem("Print",
                   ...
                   "",
                   typeof(PdfDocumentSourceSamples.PrintPage),
