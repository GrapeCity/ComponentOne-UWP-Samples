...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("LinearGauge", Strings.LinearGaugeTitle, Strings.LinearGaugeDescription, "", GetType(LinearGauge), Strings.LinearGaugeName))
            _allItems.Add(New SampleDataItem("RulerGauge", Strings.RulerGaugeTitle, Strings.RulerGaugeDescription, "", GetType(RulerGauge), Strings.RulerGaugeName))
            _allItems.Add(New SampleDataItem("Knob", Strings.KnobTitle, Strings.KnobDescription, "", GetType(Knob), Strings.KnobName))
            _allItems.Add(New SampleDataItem("RegionKnob", Strings.RegionKnobTitle, Strings.RegionKnobDescription, "", GetType(RegionKnob), Strings.RegionKnobName))
            _allItems.Add(New SampleDataItem("RadialGauge", Strings.RadialGaugeTitle, Strings.RadialGaugeDescription, "", GetType(RadialGauge), Strings.RadialGaugeName))
            _allItems.Add(New SampleDataItem("Speedometer", Strings.SpeedometerTitle, Strings.SpeedometerDescription, "", GetType(SpeedometerGauge), Strings.SpeedometerName))
            _allItems.Add(New SampleDataItem("VolumeGauge", Strings.VolumeGaugeTitle, Strings.VolumeGaugeDescription, "", GetType(VolumeGauge), Strings.VolumeGaugeName))
            _allItems.Add(New SampleDataItem("Clock", Strings.ClockTitle, Strings.ClockDescription, "", GetType(Clock), Strings.ClockName))
            _allItems.Add(New SampleDataItem("Automobile", Strings.AutomobileTitle, Strings.AutomobileDescription, "", GetType(Automobile), Strings.AutomobileName))
            _allItems.Add(New SampleDataItem("Thermometer", Strings.ThermometerTitle, Strings.ThermometerDescription, "", GetType(Thermometer), Strings.ThermometerName))
            _allItems.Add(New SampleDataItem("Rule", Strings.RuleTitle, Strings.RuleDescription, "", GetType(Rule), Strings.RuleName))
        End Sub
    End Class
End Namespace