...
namespace InputPanelSamples.Data
{
    /// <summary>
    /// Base class for <see cref="SampleDataItem"/> that defines common properties.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : InputPanelSamples.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            _allItems.Add(new SampleDataItem("BindInputPanel",
                Strings.DemoTitle,
                Strings.DemoDescription,
                "",
                typeof(BindToInputPanel),
                Strings.DemoName));
            _allItems.Add(new SampleDataItem("CustomTemplate",
                Strings.CustomTemplateTitle,
                Strings.CustomTemplateDescription,
                "",
                typeof(CustomTemplate),
                Strings.CustomTemplateName));
            _allItems.Add(new SampleDataItem("IntegrateC1FlexGrid",
               Strings.IntegrateTitle,
               Strings.IntegrateDescription,
               "",
               typeof(IntegrationC1FlexGrid),
               Strings.IntegrateName));
        }
    }
}
