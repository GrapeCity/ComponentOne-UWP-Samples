...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("BindInputPanel", Strings.DemoTitle, Strings.DemoDescription, "", GetType(BindToInputPanel), Strings.DemoName))
            _allItems.Add(New SampleDataItem("CustomTemplate", Strings.CustomTemplateTitle, Strings.CustomTemplateDescription, "", GetType(CustomTemplate), Strings.CustomTemplateName))
            _allItems.Add(New SampleDataItem("IntegrateC1FlexGrid", Strings.IntegrateTitle, Strings.IntegrateDescription, "", GetType(IntegrationC1FlexGrid), Strings.IntegrateName))
        End Sub
    End Class
End Namespace