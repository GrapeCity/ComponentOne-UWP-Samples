...
namespace ExcelSamples.Data
{
    /// <summary>
    /// Base class for <see cref="SampleDataItem"/> that defines common properties.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : ExcelSamples.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        public SampleDataSource()
        {
            _allItems.Add(new SampleDataItem("Excel",
                   Strings.ExcelSamplesTitle,
                   Strings.ExcelSamplesDescription,
                   "",
                   typeof(ExcelSamples.DemoPage),
                   Strings.ExcelSamplesName));
        }
    }
}
