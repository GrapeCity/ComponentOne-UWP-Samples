...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("Excel", Strings.ExcelSamplesTitle, Strings.ExcelSamplesDescription, "", GetType(ExcelSamples.DemoPage), Strings.ExcelSamplesName))
        End Sub
    End Class
End Namespace