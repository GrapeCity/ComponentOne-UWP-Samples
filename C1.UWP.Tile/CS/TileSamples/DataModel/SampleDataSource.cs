...
namespace TileSamples.Data
{
    ...
    public abstract class SampleDataCommon : TileSamples.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        public SampleDataSource()
        {
            _allItems.Add(new SampleDataItem("Overview",
                   ...
                   "Assets/Overview.png",
                   typeof(TileSamples.C1TileListBoxSample),
                   Strings.OverviewName));
            _allItems.Add(new SampleDataItem("Flickr",
                    Strings.FlickrTitle,
                    Strings.FlickrDescription,
                    "Assets/Flickr.png",
                    typeof(TileSamples.ListBoxSample),
                    Strings.FlickrName));
            _allItems.Add(new SampleDataItem("ContentSource",
                    Strings.ContentSourceTitle,
                    Strings.ContentSourceDescription,
                    "Assets/ContentSource.png",
                    typeof(TileSamples.ContentSourceSample),
                    Strings.ContentSourceName));
            _allItems.Add(new SampleDataItem("GridView",
                    Strings.GridViewTitle,
                    Strings.GridViewDescription,
                    "Assets/GridView.png",
                    typeof(TileSamples.GridViewSample),
                    Strings.GridViewName));
        }
    }
}
