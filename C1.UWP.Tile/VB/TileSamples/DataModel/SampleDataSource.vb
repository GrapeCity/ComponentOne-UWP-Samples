...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("Overview", Strings.OverviewTitle, Strings.OverviewDescription, "Assets/Overview.png", GetType(C1TileListBoxSample), Strings.OverviewName))
            _allItems.Add(New SampleDataItem("Flickr", Strings.FlickrTitle, Strings.FlickrDescription, "Assets/Flickr.png", GetType(ListBoxSample), Strings.FlickrName))
            _allItems.Add(New SampleDataItem("ContentSource", Strings.ContentSourceTitle, Strings.ContentSourceDescription, "Assets/ContentSource.png", GetType(ContentSourceSample), Strings.ContentSourceName))
            _allItems.Add(New SampleDataItem("GridView", Strings.GridViewTitle, Strings.GridViewDescription, "Assets/GridView.png", GetType(GridViewSample), Strings.GridViewName))
        End Sub
    End Class
End Namespace