...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            ...
            _allItems.Add(New SampleDataItem("Group", Strings.GroupTitle, Strings.GroupDescription, "", GetType(Group), Strings.GroupName))
            _allItems.Add(New SampleDataItem("BasicFeatures", Strings.BasicFeaturesTitle, Strings.BasicFeaturesDescription, "", GetType(BasicFeatures), Strings.BasicFeaturesName))
            _allItems.Add(New SampleDataItem("LegendAndTitles", Strings.LegendTitleTitle, Strings.LegendTitleDescription, "", GetType(LegendTitles), Strings.LegendTitlesName))
