...
Public NotInheritable Class SampleDataSource
    ...
    Public Sub New()
        _allItems.Add(New SampleDataItem("ColumnPie", Strings.ColumnPieTitle, Strings.ColumnPieDescription, "", GetType(ColumnPie), Strings.ColumnPieName))
        _allItems.Add(New SampleDataItem("Sunburst", Strings.SunburstTitle, Strings.SunburstDescription, "", GetType(Sunburst), Strings.SunburstName))
        _allItems.Add(New SampleDataItem("Treemap", Strings.TreemapTitle, Strings.TreemapDescription, "", GetType(Treemap), Strings.TreemapName))
    End Sub
End Class