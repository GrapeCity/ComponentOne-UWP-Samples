...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("RadarChart", Strings.RadarChartTitle, Strings.RadarChartDescription, "", GetType(RadarChart), Strings.RadarChartName))
            _allItems.Add(New SampleDataItem("PolarChart", Strings.PolarChartTitle, Strings.PolarChartDescription, "", GetType(PolarChart), Strings.PolarChartName))
        End Sub
    End Class
End Namespace