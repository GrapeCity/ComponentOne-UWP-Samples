...
Partial Public Class Advanced
    ...
    Private Sub OnAdvancedLoaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        SetupAttotations()
    End Sub
    ...
    Sub SetupAttotations()
        ...
        annotationLayer.Annotations.Add(New Annotation.Image("ms-appx:///AnnotationExplorerLib/Assets/flag.png") With {
            .SeriesIndex = 0,
            .PointIndex = 20,
            .Attachment = AnnotationAttachment.DataIndex,
        ...
        annotationLayer.Annotations.Add(New Annotation.Image("ms-appx:///AnnotationExplorerLib/Assets/arrowDOWN.png") With {
            .SeriesIndex = 0,
            .PointIndex = 30,
            .Attachment = AnnotationAttachment.DataIndex,
            .TooltipText = Strings.ArrowTooltip
        })
        annotationLayer.Annotations.Add(New Annotation.Image("ms-appx:///AnnotationExplorerLib/Assets/arrowUP.png") With {
            .SeriesIndex = 0,
            .PointIndex = 50,
            .Attachment = AnnotationAttachment.DataIndex,
            .TooltipText = Strings.ArrowTooltip
