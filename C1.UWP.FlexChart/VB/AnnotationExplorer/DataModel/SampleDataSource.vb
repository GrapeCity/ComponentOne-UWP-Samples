...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("Basic", Strings.BasicTitle, Strings.BasicDescription, "", GetType(Basic), Strings.BasicName))
            _allItems.Add(New SampleDataItem("Advanced", Strings.AdvancedTitle, Strings.AdvancedDescription, "", GetType(Advanced), Strings.AdvancedName))
            _allItems.Add(New SampleDataItem("Callouts", Strings.CalloutsTitle, Strings.CalloutsDescription, "", GetType(Callouts), Strings.CalloutsName))
        End Sub
    End Class
End Namespace