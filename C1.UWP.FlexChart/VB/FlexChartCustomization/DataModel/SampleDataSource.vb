...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("LineStyles", Strings.LineStylesTitle, Strings.LineStylesDescription, "", GetType(LineStyles), Strings.LineStylesName))
            _allItems.Add(New SampleDataItem("LegendItems", Strings.LegendItemsTitle, Strings.LegendItemsDescription, "", GetType(LegendItems), Strings.LegendItemsName))
            _allItems.Add(New SampleDataItem("LegendRanges", Strings.LegendRangesTitle, Strings.LegendRangesDescription, "", GetType(LegendRanges), Strings.LegendRangesName))
        End Sub
    End Class
End Namespace