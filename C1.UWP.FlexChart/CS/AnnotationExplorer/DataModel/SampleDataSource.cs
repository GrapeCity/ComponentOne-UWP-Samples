...
namespace AnnotationExplorer.Data
{
    /// <summary>
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            _allItems.Add(new SampleDataItem("Basic",
                Strings.BasicTitle,
                Strings.BasicDescription,
                "",
                typeof(Basic),
                Strings.BasicName));
            _allItems.Add(new SampleDataItem("Advanced",
                Strings.AdvancedTitle,
                Strings.AdvancedDescription,
                "",
                typeof(Advanced),
                Strings.AdvancedName));
            _allItems.Add(new SampleDataItem("Callouts",
                Strings.CalloutsTitle,
                Strings.CalloutsDescription,
                "",
                typeof(Callouts),
                Strings.CalloutsName));
        }
    }
}
