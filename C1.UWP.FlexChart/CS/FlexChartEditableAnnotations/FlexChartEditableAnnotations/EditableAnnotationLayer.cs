...
using Windows.UI;
using FlexChartEditableAnnotations;
...
namespace FlexChartEditableAnnotations
{
    ...
    public class EditableAnnotationLayer : AnnotationLayer
    {
        ...
        public EditableAnnotationLayer(C1FlexChart chart)
        {
            ...
            _flexChart.KeyDown += _flexChart_KeyDown;
        ...
        private void _flexChart_KeyDown(object sender, KeyRoutedEventArgs e)
        {
                ...
                if (FlexChart.HitTest(_start).ChartElement == ChartElement.PlotArea)
                {
                    ...
                    if (_annotationToAdd is Text)
                    {
                        ...
                        if (anno == null)
                        {
                            ...
                            {
                                _annotationToAdd.Style = TextAnnoStyle;
                    ...
                    _isDragging = false;
                    _annotationToAdd.Style = new ChartStyle { Fill = new SolidColorBrush(Colors.Red) };
                    this.Annotations.Add(_annotationToAdd);
                    SelectedAnnotation = _annotationToAdd;
                    _flexChart.Invalidate();
                }
