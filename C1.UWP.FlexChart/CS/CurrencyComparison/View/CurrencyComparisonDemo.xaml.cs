...
namespace CurrencyComparison
{
    ...
    /// </summary>
    public partial class CurrencyComparisonDemo : Page
    {
        ...
        {
            var from = HelperExtensions.FromOADate(mainChart.AxisX.GetMin()).ToShortDateString();
            var to = HelperExtensions.FromOADate(mainChart.AxisX.GetMax()).ToShortDateString();
        ...
        void HandleCurrenciesSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
        ...
        void HandleRangeSelectorValueChanged(object sender, EventArgs e)
        {
            if (_rangeChartRendered)
            {
                ...
                rangeChart.Rendered -= HandleRangeChartRendered;
                UpdateToFromDates();
            }
        }
        ...
        {
            var max = rangeChart.AxisX.GetMax();
            var min = rangeChart.AxisX.GetMin();
        ...
        void HandleMainChartMouseMove(object sender, PointerRoutedEventArgs e)
        {
            var hitTestInfo = mainChart.HitTest(e.GetCurrentPoint(mainChart).Position);
