...
namespace DrillDown.Data
{
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            _allItems.Add(new SampleDataItem("BasicDrillDown",
                Strings.BasicDrillDownTitle,
                Strings.BasicDrillDownDescription,
                "",
                typeof(BasicDrillDownSample),
                Strings.BasicDrillDownName));
            _allItems.Add(new SampleDataItem("AsyncDrillDown",
                Strings.AsyncDrillDownTitle,
                Strings.AsyncDrillDownDescription,
                "",
                typeof(AsyncDrillDownSample),
                Strings.AsyncDrillDownName));
            _allItems.Add(new SampleDataItem("Sunburst",
                Strings.SunburstTitle,
                Strings.SunburstDescription,
                "",
                typeof(SunburstSample),
                Strings.SunburstName));
            _allItems.Add(new SampleDataItem("Treemap",
                Strings.TreemapTitle,
                Strings.TreemapDescription,
                "",
                typeof(TreemapSample),
                Strings.TreemapName));
        }
    }
}
