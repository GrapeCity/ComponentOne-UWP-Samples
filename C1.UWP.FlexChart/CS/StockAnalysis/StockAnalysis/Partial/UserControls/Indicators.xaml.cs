...
{
    public sealed partial class Indicators : UserControl
    {
        public Indicators()
        {
        ...
        private void SettableCheckBox_Checked(object sender, RoutedEventArgs e)
        {
            ...
            Type type = Type.GetType("StockAnalysis.Partial.CustomControls.IndicatorSeries." + check.Tag);
            if (type == null)
            {
                type = Type.GetType("StockAnalysis.Partial.CustomControls.CustomIndicator." + check.Tag);
            }
