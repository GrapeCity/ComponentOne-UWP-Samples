    ...
    public class PivotPoint : IndicatorSeries.IndicatorSeriesBase
    {
        ...
        public PivotPoint(C1FlexChart chart, string plotAreaName = null) : base()
        {
            ...
            if (!string.IsNullOrEmpty(plotAreaName))
            {
                ...
                this.AxisY.TitleStyle.FontWeight = Windows.UI.Text.FontWeights.Bold;
            ...
            Utilities.Helper.BindingSettingsParams(chart, this, typeof(PivotPoint), "Pivot Points",
            ...
            Utilities.Helper.BindingSettingsParams(chart, series, typeof(PivotPointSeries), "Pivot Points",
                new Data.PropertyParam[]
                {
            ...
            Utilities.Helper.BindingSettingsParams(chart, r1, typeof(PivotPointSeries), "Pivot Points",
                new Data.PropertyParam[]
                {
            ...
            Utilities.Helper.BindingSettingsParams(chart, r2, typeof(PivotPointSeries), "Pivot Points",
                new Data.PropertyParam[]
                {
            ...
            Utilities.Helper.BindingSettingsParams(chart, r3, typeof(PivotPointSeries), "Pivot Points",
                new Data.PropertyParam[]
                {
            ...
            Utilities.Helper.BindingSettingsParams(chart, s1, typeof(PivotPointSeries), "Pivot Points",
                new Data.PropertyParam[]
                {
            ...
            Utilities.Helper.BindingSettingsParams(chart, s2, typeof(PivotPointSeries), "Pivot Points",
                new Data.PropertyParam[]
                {
            ...
            Utilities.Helper.BindingSettingsParams(chart, s3, typeof(PivotPointSeries), "Pivot Points",
                new Data.PropertyParam[]
                {
