...
namespace FloatingBarChart.Data
{
    /// <summary>
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            _allItems.Add(new SampleDataItem("FloatingBar",
                Strings.FloatingBarTitle,
                Strings.FloatingBarDescription,
                "",
                typeof(FloatingBar),
                Strings.FloatingBarName));
            _allItems.Add(new SampleDataItem("Gantt",
                Strings.GanttTitle,
                Strings.GanttDescription,
                "",
                typeof(Gantt),
                Strings.GanttName));
            _allItems.Add(new SampleDataItem("RangedArea",
                Strings.RangedAreaTitle,
                Strings.RangedAreaDescription,
                "",
                typeof(RangedArea),
                Strings.RangedAreaName));
        }
    }
}
