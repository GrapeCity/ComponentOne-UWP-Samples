...
namespace DataManipulation.Data
{
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            _allItems.Add(new SampleDataItem("TopN",
                Strings.TopNTitle,
                Strings.TopNDescription,
                "",
                typeof(TopNView),
                Strings.TopNName));
            _allItems.Add(new SampleDataItem("Sorting",
                Strings.SortingTitle,
                Strings.SortingDescription,
                "",
                typeof(SortingView),
                Strings.SortingName));
            _allItems.Add(new SampleDataItem("Aggregate",
                Strings.AggregateTitle,
                Strings.AggregateDescription,
                "",
                typeof(AggregateView),
                Strings.AggregateName));
            _allItems.Add(new SampleDataItem("YFunction",
                Strings.YFunctionTitle,
                Strings.YFunctionDescription,
                "",
                typeof(YFunctionSeriesView),
                Strings.YFunctionName));
            _allItems.Add(new SampleDataItem("ParametricFunction",
                Strings.ParametricFunctionTitle,
                Strings.ParametricFunctionDescription,
                "",
                typeof(ParametricFunctionSeriesView),
                Strings.ParametricFunctionName));
        }
    }
}
