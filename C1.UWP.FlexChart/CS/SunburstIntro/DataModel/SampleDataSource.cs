...
namespace SunburstIntro.Data
{
    ...
    public sealed class SampleDataSource
    {
        ...
        public SampleDataSource()
        {
            ...
            _allItems.Add(new SampleDataItem("Group",
                Strings.GroupTitle,
                Strings.GroupDescription,
                "",
                typeof(Group),
                Strings.GroupName));
            _allItems.Add(new SampleDataItem("BasicFeatures",
                Strings.BasicFeaturesTitle,
                Strings.BasicFeaturesDescription,
                "",
                typeof(BasicFeatures),
                Strings.BasicFeaturesName));
            _allItems.Add(new SampleDataItem("LegendAndTitles",
                Strings.LegendTitleTitle,
                Strings.LegendTitleDescription,
                "",
                typeof(LegendTitles),
                Strings.LegendTitlesName));
