...
namespace FlexRadarIntro.Data
{
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            _allItems.Add(new SampleDataItem("RadarChart",
                Strings.RadarChartTitle,
                Strings.RadarChartDescription,
                "",
                typeof(RadarChart),
                Strings.RadarChartName));
            _allItems.Add(new SampleDataItem("PolarChart",
                Strings.PolarChartTitle,
                Strings.PolarChartDescription,
                "",
                typeof(PolarChart),
                Strings.PolarChartName));
        }
    }
}
