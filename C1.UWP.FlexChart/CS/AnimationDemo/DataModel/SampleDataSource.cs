...
namespace AnimationDemo.Data
{
    ...
    public abstract class SampleDataCommon : AnimationDemo.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            _allItems.Add(new SampleDataItem("FlexChartAnimation",
                    Strings.FlexChartAnimationTitle,
                    Strings.FlexChartAnimationDescription,
                    "Assets/LightGray.png",
                    typeof(View.FlexChartAnimation),
                    Strings.FlexChartAnimationName));

            _allItems.Add(new SampleDataItem("FlexPieAnimation",
                Strings.FlexPieAnimationTitle,
                Strings.FlexPieAnimationDescription,
                "Assets/DarkGray.png",
                typeof(View.FlexPieAnimation),
                Strings.FlexPieAnimationName));

            _allItems.Add(new SampleDataItem("CustomAnimation",
                Strings.CustomAnimationTitle,
                Strings.CustomAnimationDescription,
                "Assets/LightGray.png",
                typeof(View.CustomAnimation),
                Strings.CustomAnimationName));
        }
    }
}
