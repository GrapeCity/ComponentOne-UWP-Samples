...
{
    public sealed partial class DateTimeAxisGrouping : Page
    {
        ...
        public class MyDateTimeGroupProvider : IAxisGroupProvider
        {
            ...
            public int GetLevels(IRange range)
            {
                ...
                if (_groupTypes.Count == 0)
                {
                    ...
                    TimeRange timeRange = range as TimeRange;
                    if (timeRange == null) return 0;

                    DateTime start = timeRange.TimeMin;
                    DateTime end = timeRange.TimeMax;
    ...
    public class IntToGroupVisibilityLevelConverter : Windows.UI.Xaml.Data.IValueConverter
    {
