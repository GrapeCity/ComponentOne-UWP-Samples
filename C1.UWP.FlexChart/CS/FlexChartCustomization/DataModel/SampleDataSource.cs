...
namespace FlexChartCustomization.Data
{
    /// <summary>
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            _allItems.Add(new SampleDataItem("LineStyles",
                Strings.LineStylesTitle,
                Strings.LineStylesDescription,
                "",
                typeof(LineStyles),
                Strings.LineStylesName));
            _allItems.Add(new SampleDataItem("LegendItems",
                Strings.LegendItemsTitle,
                Strings.LegendItemsDescription,
                "",
                typeof(LegendItems),
                Strings.LegendItemsName));
            _allItems.Add(new SampleDataItem("LegendRanges",
                Strings.LegendRangesTitle,
                Strings.LegendRangesDescription,
                "",
                typeof(LegendRanges),
                Strings.LegendRangesName));
        }
    }
}
