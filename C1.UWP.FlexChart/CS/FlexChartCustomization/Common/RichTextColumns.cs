...
namespace FlexChartCustomization.Common
{
    /// <summary>
    ...
    /// <code>
    /// <RichTextLegendItems>
    ///     <RichTextLegendItems.ColumnTemplate>
    ///         <DataTemplate>
    ...
    public sealed class RichTextLegendItems : Panel
    {
        /// <summary>
        ...
        public static readonly DependencyProperty RichTextContentProperty =
            ...
            typeof(RichTextLegendItems), new PropertyMetadata(null, ResetOverflowLayout));
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RichTextLegendItems"/> class.
        /// </summary>
        public RichTextLegendItems()
        {
        ...
        /// </summary>
        /// <param name="d">Instance of <see cref="RichTextLegendItems"/> where the change
        /// occurred.</param>
        ...
        private static void ResetOverflowLayout(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            var target = d as RichTextLegendItems;
            if (target != null)
            {
                target._overflowLegendItems = null;
        ...
        /// RichTextBlock child.
        /// </summary>
        private List<RichTextBlockOverflow> _overflowLegendItems = null;
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            // done yet
            if (this._overflowLegendItems == null)
            {
                Children.Add(this.RichTextContent);
                this._overflowLegendItems = new List<RichTextBlockOverflow>();
            }
            ...
            while (hasOverflow && maxWidth < availableSize.Width && this.ColumnTemplate != null)
            {
                ...
                if (this._overflowLegendItems.Count > overflowIndex)
                {
                    overflow = this._overflowLegendItems[overflowIndex];
                }
                else
                {
                    overflow = (RichTextBlockOverflow)this.ColumnTemplate.LoadContent();
                    this._overflowLegendItems.Add(overflow);
                    ...
                    {
                        this._overflowLegendItems[overflowIndex - 1].OverflowContentTarget = overflow;
                    }
                }
            ...
            if (this._overflowLegendItems.Count > overflowIndex)
            {
                ...
                {
                    this._overflowLegendItems[overflowIndex - 1].OverflowContentTarget = null;
                }
                while (this._overflowLegendItems.Count > overflowIndex)
                {
                    this._overflowLegendItems.RemoveAt(overflowIndex);
