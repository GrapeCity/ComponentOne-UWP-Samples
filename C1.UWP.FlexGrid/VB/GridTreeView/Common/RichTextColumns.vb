Namespace GridTreeViewSamples.RichCommon
    ''' <summary>
    ...
    Public NotInheritable Class RichTextColumns
        ...
        ''' </summary>
        Public Shared ReadOnly RichTextContentProperty As DependencyProperty = DependencyProperty.Register("RichTextContent", GetType(RichTextBlock), GetType(RichTextColumns), New PropertyMetadata(Nothing, New PropertyChangedCallback(AddressOf ResetOverflowLayout)))

        ''' <summary>
        ''' Identifies the <see cref="ColumnTemplate"/> dependency property.
        ''' </summary>
        Public Shared ReadOnly ColumnTemplateProperty As DependencyProperty = DependencyProperty.Register("ColumnTemplate", GetType(DataTemplate), GetType(RichTextColumns), New PropertyMetadata(Nothing, New PropertyChangedCallback(AddressOf ResetOverflowLayout)))
        ...
        Public Property RichTextContent() As RichTextBlock
            Get
                Return CType(GetValue(RichTextContentProperty), RichTextBlock)
            End Get
            Set
        ...
        Private Shared Sub ResetOverflowLayout(d As DependencyObject, e As DependencyPropertyChangedEventArgs)
        ...
        Protected Overrides Function MeasureOverride(availableSize As Size) As Size
            If Me.RichTextContent Is Nothing Then
                Return New Size(0, 0)
            End If
            ...
            If Me._overflowColumns Is Nothing Then
                Children.Add(Me.RichTextContent)
            ...
            While hasOverflow AndAlso maxWidth < availableSize.Width AndAlso Me.ColumnTemplate IsNot Nothing
                ...
                Else
                    overflow = CType(Me.ColumnTemplate.LoadContent(), RichTextBlockOverflow)
