...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("GridTreeView", Strings.GridTreeViewSamplesTitle, Strings.GridTreeViewSamplesDescription, "", GetType(GridTreeViewSample), Strings.GridTreeViewSamplesName))
        End Sub
    End Class
End Namespace