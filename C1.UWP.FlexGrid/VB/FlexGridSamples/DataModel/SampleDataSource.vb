...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            ...
            _allItems.Add(New SampleDataItem("Financial", Strings.FinancialTitle, Strings.FinancialDescription, "Assets/Financial.png", GetType(Financial), Strings.FinancialName))
            _allItems.Add(New SampleDataItem("CollectionView", Strings.CollectionViewTitle, Strings.CollectionViewDescription, "Assets/CollectionView.png", GetType(CollectionView), Strings.CollectionViewName))
            _allItems.Add(New SampleDataItem("Media Library", Strings.MediaLibraryTitle, Strings.MediaLibraryDescription, "Assets/itunes.png", GetType(MediaLibrary), Strings.MediaLibraryName))
            _allItems.Add(New SampleDataItem("Editing", Strings.EditingTitle, Strings.EditingDescription, "Assets/Editing.png", GetType(Editing), Strings.EditingName))
            _allItems.Add(New SampleDataItem("Unbound", Strings.UnboundTitle, Strings.UnboundDescription, "Assets/Unbound.png", GetType(Unbound), Strings.UnboundName))
            _allItems.Add(New SampleDataItem("CustomColumns", Strings.CustomColumnsTitle, Strings.CustomColumnsDescription, "Assets/CustomColumns.png", GetType(CustomColumns), Strings.CustomColumnsName))
            _allItems.Add(New SampleDataItem("Cell Merging", Strings.CellMergingTitle, Strings.CellMergingDescription, "Assets/CellMerging.png", GetType(ExcelStyleMerge), Strings.CellMergingName))
            _allItems.Add(New SampleDataItem("Printing", Strings.PrintingTitle, Strings.PrintingDescription, "Assets/Printing.png", GetType(Printing), Strings.PrintingName))
            _allItems.Add(New SampleDataItem("Drag-drop", Strings.DragDropTitle, Strings.DragDropDescription, "Assets/DragDropRows.png", GetType(DragDropRows), Strings.DragDropName))
            _allItems.Add(New SampleDataItem("RowDetails", Strings.RowDetailsTitle, Strings.RowDetailsDescription, "Assets/RowDetails.png", GetType(RowDetails), Strings.RowDetailsName))
        End Sub
    End Class
End Namespace