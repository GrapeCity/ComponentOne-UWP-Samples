...
namespace GridTreeViewSamples.Data
{
    /// <summary>
    /// Base class for <see cref="SampleDataItem"/> that defines common properties.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : GridTreeViewSamples.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            _allItems.Add(new SampleDataItem("GridTreeView",
                   Strings.GridTreeViewSamplesTitle,
                   Strings.GridTreeViewSamplesDescription,
                   "",
                   typeof(GridTreeViewSamples.GridTreeViewSample),
                   Strings.GridTreeViewSamplesName));
        }
    }
}
