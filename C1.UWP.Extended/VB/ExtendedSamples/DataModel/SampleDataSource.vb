...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("BookDemo", Strings.BookDemoTitle, Strings.BookDemoDescription, "Assets/LightGray.png", GetType(C1BookDemo), Strings.BookDemoName))
            _allItems.Add(New SampleDataItem("BookPageSpan", Strings.BookPageSpanTitle, Strings.BookPageSpanDescription, "Assets/LightGray.png", GetType(C1BookPageSpan), Strings.BookPageSpanName))
            _allItems.Add(New SampleDataItem("ColorPickerDemo", Strings.ColorPickerDemoTitle, Strings.ColorPickerDemoDescription, "Assets/LightGray.png", GetType(C1ColorPickerDemo), Strings.ColorPickerDemoName))
        End Sub
    End Class
End Namespace