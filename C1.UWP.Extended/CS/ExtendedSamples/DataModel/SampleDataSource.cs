...
namespace ExtendedSamples.Data
{
    /// <summary>
    /// Base class for <see cref="SampleDataItem"/> that defines common properties.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : ExtendedSamples.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            _allItems.Add(new SampleDataItem("BookDemo",
                    Strings.BookDemoTitle,
                    Strings.BookDemoDescription,
                    "Assets/LightGray.png",
                    typeof(ExtendedSamples.C1BookDemo),
                    Strings.BookDemoName));
            _allItems.Add(new SampleDataItem("BookPageSpan",
                    Strings.BookPageSpanTitle,
                    Strings.BookPageSpanDescription,
                    "Assets/LightGray.png",
                    typeof(ExtendedSamples.C1BookPageSpan),
                    Strings.BookPageSpanName));
            _allItems.Add(new SampleDataItem("ColorPickerDemo",
                    Strings.ColorPickerDemoTitle,
                    Strings.ColorPickerDemoDescription,
                    "Assets/LightGray.png",
                    typeof(ExtendedSamples.C1ColorPickerDemo),
                    Strings.ColorPickerDemoName));
        }
    }
}
