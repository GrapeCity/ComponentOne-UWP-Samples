...
namespace PdfViewerSamples.Data
{
    /// <summary>
    /// Base class for <see cref="SampleDataItem"/> that defines common properties.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : PdfViewerSamples.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        public SampleDataSource()
        {
            _allItems.Add(new SampleDataItem("See it in action",
                ...
                "",
                typeof(PdfViewerDemoPage),
                Strings.DemoName));
            _allItems.Add(new SampleDataItem("Large Files",
                Strings.LargeFileTitle,
                Strings.LargeFileDescription,
                "",
                typeof(LargeFile),
                Strings.LargeFileName));
