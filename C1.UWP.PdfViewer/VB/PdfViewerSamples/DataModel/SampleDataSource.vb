...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("See it in action", Strings.DemoTitle, Strings.DemoDescription, "", GetType(PdfViewerDemoPage), Strings.DemoName))
            _allItems.Add(New SampleDataItem("Large Files", Strings.LargeFileTitle, Strings.LargeFileDescription, "", GetType(LargeFile), Strings.LargeFileName))
