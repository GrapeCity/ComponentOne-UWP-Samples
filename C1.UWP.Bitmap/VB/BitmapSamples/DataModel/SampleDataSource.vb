...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("GifImage", Strings.GifImageTitle, Strings.GifImageDescription, "", GetType(DemoGifImage), Strings.GifImageName))
            _allItems.Add(New SampleDataItem("Crop", Strings.CropTitle, Strings.CropDescription, "", GetType(Crop), Strings.CropName))
            _allItems.Add(New SampleDataItem("FaceWarp", Strings.FaceWarpTitle, Strings.FaceWarpDescription, "", GetType(FaceWarp), Strings.FaceWarpName))
            _allItems.Add(New SampleDataItem("Transform", Strings.TransformTitle, Strings.TransformDescription, "", GetType(Transform), Strings.TransformName))
        End Sub
    End Class
End Namespace