...
namespace BitmapSamples.Data
{
    /// <summary>
    /// Base class for <see cref="SampleDataItem"/> that defines common properties.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : BitmapSamples.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            _allItems.Add(new SampleDataItem("GifImage",
                    Strings.GifImageTitle,
                    Strings.GifImageDescription,
                    "",
                    typeof(BitmapSamples.DemoGifImage),
                    Strings.GifImageName));
            _allItems.Add(new SampleDataItem("Crop",
                    Strings.CropTitle,
                    Strings.CropDescription,
                    "",
                    typeof(BitmapSamples.Crop),
                    Strings.CropName));
            _allItems.Add(new SampleDataItem("FaceWarp",
                    Strings.FaceWarpTitle,
                    Strings.FaceWarpDescription,
                    "",
                    typeof(BitmapSamples.FaceWarp),
                    Strings.FaceWarpName));
            _allItems.Add(new SampleDataItem("Transform",
                    Strings.TransformTitle,
                    Strings.TransformDescription,
                    "",
                    typeof(BitmapSamples.Transform),
                    Strings.TransformName));
        }
    }
}
