...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("ColumnCalculation", Strings.IntegrationGridColumnCalculationTitle, Strings.IntegrationGridColumnCalculationDescription, "", GetType(ColumnCalculation), Strings.IntegrationGridColumnCalculationName))
            _allItems.Add(New SampleDataItem("Filtering", Strings.IntegrationGridSupportFilterTitle, Strings.IntegrationGridSupportFilterDescription, "", GetType(SupportFilter), Strings.IntegrationGridSupportFilterName))
            _allItems.Add(New SampleDataItem("Grouping", Strings.IntegrationGridSupportGroupingTitle, Strings.IntegrationGridSupportGroupingDescription, "", GetType(SupportGrouping), Strings.IntegrationGridSupportGroupingName))
            _allItems.Add(New SampleDataItem("FlexChartFilter", Strings.FlexChartSamplesTitle, Strings.FlexChartSamplesDescription, "", GetType(FlexChartFilter), Strings.FlexChartSamplesName))
        End Sub
    End Class
End Namespace