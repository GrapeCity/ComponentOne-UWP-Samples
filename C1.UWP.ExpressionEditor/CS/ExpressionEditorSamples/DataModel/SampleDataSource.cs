...
namespace ExpressionEditorSamples.Data
{
    /// <summary>
    /// Base class for <see cref="SampleDataItem"/> that defines common properties.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : ExpressionEditorSamples.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            _allItems.Add(new SampleDataItem("ColumnCalculation",
                Strings.IntegrationGridColumnCalculationTitle,
                Strings.IntegrationGridColumnCalculationDescription,
                "",
                typeof(ExpressionEditorSamples.ColumnCalculation),
                Strings.IntegrationGridColumnCalculationName));

            _allItems.Add(new SampleDataItem("Filtering",
                Strings.IntegrationGridSupportFilterTitle,
                Strings.IntegrationGridSupportFilterDescription,
                "",
                typeof(ExpressionEditorSamples.SupportFilter),
                 Strings.IntegrationGridSupportFilterName));

            _allItems.Add(new SampleDataItem("Grouping",
                Strings.IntegrationGridSupportGroupingTitle,
                Strings.IntegrationGridSupportGroupingDescription,
                "",
                typeof(ExpressionEditorSamples.SupportGrouping),
                Strings.IntegrationGridSupportGroupingName));

            _allItems.Add(new SampleDataItem("FlexChartFilter",
                Strings.FlexChartSamplesTitle,
                Strings.FlexChartSamplesDescription,
                "",
                typeof(ExpressionEditorSamples.FlexChartFilter),
                Strings.FlexChartSamplesName));
        }
    }
}
