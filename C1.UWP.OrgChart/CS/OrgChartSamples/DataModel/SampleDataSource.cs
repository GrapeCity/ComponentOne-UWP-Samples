...
namespace OrgChartSamples.Data
{
    /// <summary>
    /// Base class for <see cref="SampleDataItem"/> that defines common properties.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : OrgChartSamples.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        public SampleDataSource()
        {
            _allItems.Add(new SampleDataItem("Overview",
                  Strings.OrgChartSamplesOverviewTitle,
                  Strings.OrgChartSamplesOverviewDescription,
                  "",
                  typeof(OrgChartSamples.MainSample),
                  Strings.OrgChartSamplesOverviewName));
            _allItems.Add(new SampleDataItem("TemplateSelector",
                    Strings.OrgChartSamplesTemplateSelectorTitle,
                    Strings.OrgChartSamplesTemplateSelectorDescription,
                    "",
                    typeof(OrgChartSamples.TemplateSample),
                    Strings.OrgChartSamplesTemplateSelectorName));
            _allItems.Add(new SampleDataItem("HierarchicalSample",
                    Strings.OrgChartSamplesHierarchicalSampleTitle,
                    Strings.OrgChartSamplesHierarchicalSampleDescription,
                    "",
                    typeof(OrgChartSamples.HierarchicalSample),
                    Strings.OrgChartSamplesHierarchicalSampleName));
            _allItems.Add(new SampleDataItem("CollapseExpand",
                    Strings.OrgChartSamplesCollapseExpandTitle,
                    Strings.OrgChartSamplesCollapseExpandDescription,
                    "",
                    typeof(OrgChartSamples.CollapseExpand),
                    Strings.OrgChartSamplesCollapseExpandName));
        }
    }
}
