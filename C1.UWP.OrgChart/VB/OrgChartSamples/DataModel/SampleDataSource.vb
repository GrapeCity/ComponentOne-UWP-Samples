...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("Overview", Strings.OrgChartSamplesOverviewTitle, Strings.OrgChartSamplesOverviewDescription, "", GetType(MainSample), Strings.OrgChartSamplesOverviewName))
            _allItems.Add(New SampleDataItem("TemplateSelector", Strings.OrgChartSamplesTemplateSelectorTitle, Strings.OrgChartSamplesTemplateSelectorDescription, "", GetType(TemplateSample), Strings.OrgChartSamplesTemplateSelectorName))
            _allItems.Add(New SampleDataItem("HierarchicalSample", Strings.OrgChartSamplesHierarchicalSampleTitle, Strings.OrgChartSamplesHierarchicalSampleDescription, "", GetType(HierarchicalSample), Strings.OrgChartSamplesHierarchicalSampleName))
            _allItems.Add(New SampleDataItem("CollapseExpand", Strings.OrgChartSamplesCollapseExpandTitle, Strings.OrgChartSamplesCollapseExpandDescription, "", GetType(CollapseExpand), Strings.OrgChartSamplesCollapseExpandName))
        End Sub
    End Class
End Namespace