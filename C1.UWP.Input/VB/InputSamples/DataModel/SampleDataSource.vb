...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("MultiSelect", Strings.MultiSelectTitle, Strings.MultiSelectDescription, "", GetType(InputSamples.MultiSelect), Strings.MultiSelectName))
            _allItems.Add(New SampleDataItem("CheckList", Strings.CheckListTitle, Strings.CheckListDescription, "", GetType(InputSamples.CheckList), Strings.CheckListName))
            _allItems.Add(New SampleDataItem("TagEditor", Strings.TagEditorTitle, Strings.TagEditorDescription, "", GetType(InputSamples.TagEditor), Strings.TagEditorName))
        End Sub
    End Class
End Namespace