...
namespace InputSamples.Data
{
    /// <summary>
    /// Base class for <see cref="SampleDataItem"/> that defines common properties.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : InputSamples.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            _allItems.Add(new SampleDataItem("MultiSelect",
                Strings.MultiSelectTitle,
                Strings.MultiSelectDescription,
                "",
                typeof(InputSamples.MultiSelect),
                Strings.MultiSelectName));

            _allItems.Add(new SampleDataItem("CheckList",
                Strings.CheckListTitle,
                Strings.CheckListDescription,
                "",
                typeof(InputSamples.CheckList),
                Strings.CheckListName));

            _allItems.Add(new SampleDataItem("TagEditor",
                Strings.TagEditorTitle,
                Strings.TagEditorDescription,
                "",
                typeof(InputSamples.TagEditor),
                Strings.TagEditorName));
