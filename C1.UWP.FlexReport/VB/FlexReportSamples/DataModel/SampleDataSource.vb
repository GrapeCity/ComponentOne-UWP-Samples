...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("Viewer", Strings.ViewerSamplePageTitle, Strings.ViewerSamplePageDescription, "", GetType(FlexReportSamples.ViewerPage), Strings.ViewerSamplePageName))
            _allItems.Add(New SampleDataItem("Viewer Pane", Strings.ViewerPaneSamplePageTitle, Strings.ViewerPaneSamplePageDescription, "", GetType(FlexReportSamples.ViewerPanePage), Strings.ViewerPaneSamplePageName))
            _allItems.Add(New SampleDataItem("Export", Strings.ExportSamplePageTitle, Strings.ExportSamplePageDescription, "", GetType(FlexReportSamples.ExportPage), Strings.ExportSamplePageName))
            _allItems.Add(New SampleDataItem("Print", Strings.PrintSamplePageTitle, Strings.PrintSamplePageDescription, "", GetType(FlexReportSamples.PrintPage), Strings.PrintSamplePageName))
        End Sub
    End Class
End Namespace