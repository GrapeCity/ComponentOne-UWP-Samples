...
namespace BarCodeSamples.Data
{
    /// <summary>
    /// Base class for <see cref="SampleDataItem"/> that defines common properties.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : BarCodeSamples.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            _allItems.Add(new SampleDataItem("BarCode",
                   Strings.BarCodeSamplesTitle,
                   Strings.BarCodeSamplesDescription,
                   "",
                   typeof(BarCodeSamples.DemoBarCode),
                   Strings.BarCodeSamplesName));
            _allItems.Add(new SampleDataItem("NewBarCode",
                   Strings.NewBarCodeSamplesTitle,
                   Strings.NewBarCodeSamplesDescription,
                   "",
                   typeof(BarCodeSamples.NewBarcodes),
                   Strings.NewBarCodeSamplesName));
        }
    }
}
