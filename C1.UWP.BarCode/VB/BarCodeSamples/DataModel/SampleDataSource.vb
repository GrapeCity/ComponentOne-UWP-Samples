...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("BarCode", Strings.BarCodeSamplesTitle, Strings.BarCodeSamplesDescription, "", GetType(DemoBarCode), Strings.BarCodeSamplesName))
            _allItems.Add(New SampleDataItem("NewBarCode", Strings.NewBarCodeSamplesTitle, Strings.NewBarCodeSamplesDescription, "", GetType(NewBarcodes), Strings.NewBarCodeSamplesName))
        End Sub
    End Class
End Namespace