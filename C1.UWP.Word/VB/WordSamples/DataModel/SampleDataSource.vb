...
Namespace Data
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Public Sub New()
            _allItems.Add(New SampleDataItem("Basic Text", Strings.WordSamplesBasicTextTitle, Strings.WordSamplesBasicTextDescription, "Assets/BasicText.png", GetType(BasicTextPage), Strings.WordSamplesBasicTextName))
            _allItems.Add(New SampleDataItem("Images", Strings.WordSamplesImagesTitle, Strings.WordSamplesImagesDescription, "Assets/MediumGray.png", GetType(ImagesPage), Strings.WordSamplesImagesName))
            _allItems.Add(New SampleDataItem("Graphics", Strings.WordSamplesGraphicsTitle, Strings.WordSamplesGraphicsDescription, "Assets/Graphics.png", GetType(GraphicsPage), Strings.WordSamplesGraphicsName))
            _allItems.Add(New SampleDataItem("Quotes", Strings.WordSamplesQuotesTitle, Strings.WordSamplesQuotesDescription, "Assets/Quotes.png", GetType(QuotesPage), Strings.WordSamplesQuotesName))
            _allItems.Add(New SampleDataItem("Table of Contents", Strings.WordSamplesTableOfContentsTitle, Strings.WordSamplesTableOfContentsDescription, "Assets/TOC.png", GetType(TOCPage), Strings.WordSamplesTableOfContentsName))
            _allItems.Add(New SampleDataItem("Text Flow", Strings.WordSamplesTextFlowTitle, Strings.WordSamplesTextFlowDescription, "Assets/TextFlow.png", GetType(TextFlowPage), Strings.WordSamplesTextFlowName))
            _allItems.Add(New SampleDataItem("Paper Sizes", Strings.WordSamplesPaperSizesTitle, Strings.WordSamplesPaperSizesDescription, "Assets/PaperSizes.png", GetType(PaperSizesPage), Strings.WordSamplesPaperSizesName))
            _allItems.Add(New SampleDataItem("Export UI", Strings.WordSamplesExportUITitle, Strings.WordSamplesExportUIDescription, "Assets/MediumGray.png", GetType(RenderUIPage), Strings.WordSamplesExportUIName))
        End Sub
    End Class
End Namespace